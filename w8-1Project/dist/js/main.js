...
var ShoppingCart = /*#__PURE__*/function (_Cart) {
  _inherits(ShoppingCart, _Cart);
...
(function () {
  var username = 'laoxie';
  var content = "hello my name is ".concat(username);
...
(function ($) {
  ...
  $.fn.slideRight = function (speed, easing, callback) {
    ...
    // 显示，width:0
    this.show();
    var startWidth = this.data('initValue');
